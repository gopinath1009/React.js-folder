        ...
        <div className="flex align-items-center justify-content-center">
            <div className="surface-card p-4 shadow-2 border-round w-full lg:w-6">
                <div className="text-center mb-5">
                    ...
                    <div className="text-900 text-3xl font-medium mb-3">Welcome Back Teacher</div>
                    {/* <span className="text-600 font-medium line-height-3">Don't have an account?</span> */}
                    <a className="font-medium no-underline ml-2 text-blue-500 cursor-pointer"> Teacher login!</a>
                </div>

                <div>
                    <label htmlFor="Teacher Id" className="block text-900 font-medium mb-2">Teacher Id</label>
                    <InputText id="Teacher Id" value={IdValue}  onChange={handle} type="number" placeholder="Teacher Id" className="w-full mb-3" />
